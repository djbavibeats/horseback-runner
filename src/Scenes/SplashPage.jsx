...
function SplashPage({ setActiveScreen }) {
    return (
        <>
        <div className="relative flex flex-col items-center gap-2 mt-[-1rem]">
            <img className="w-[90%]" src={ JennaPauletteStackedLogo } />
            <p className="font-snide-asides text-2xl">And</p>
            <img className="w-[90%]" src={ JustinBootsLogo } />
            <p className="font-snide-asides text-2xl">Present</p>
            <img className="w-[90%]" src={ HorsebackLogo } />
